...
func _totp(using secret: String) -> String {
...
func totp(secret: String, format: String) -> String {
    let password = _totp(using: secret)
    return format.replacingOccurrences(of: "<@>", with: password)
}
